...
from ..base.skycoord import SkyCoordSchema, TOOAPISkyCoord
from ..base.status import TOOStatus
from ..swift.schema import (
    SwiftTOODeleteSchema,
    SwiftTOOGetSchema,
    SwiftTOOPostSchema,
    SwiftTOOPutSchema,
    SwiftTOOSchema,
...
class SwiftTOO(
    ...
    TOOAPIBaseClass,
    SkyCoordSchema,
    TOOAPIAutoResolve,  # TOOAPIInstruments
):
    _get_schema = SwiftTOOGetSchema
    _post_schema = SwiftTOOPostSchema
    _put_schema = SwiftTOOPutSchema
    _del_schema = SwiftTOODeleteSchema
