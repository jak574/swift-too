...
from .common import convert_to_dt

HAS_ASTROPY = False
try:
    import astropy.units as u  # type: ignore[import]
    from astropy.time import TimeDelta  # type: ignore[import]
...
class TOOAPIDateRange:
    ...
    def length(self, length):
        ...
        elif isinstance(length, timedelta):
    ...
    def exposure(self, exposure):
        ...
        elif isinstance(exposure, timedelta):
